...
public class ReinforceItem extends Item {
    ...
    public static final String MATERIAL = PritheeBeCareful.MOD_ID+".material";
    public static final String GEAR = PritheeBeCareful.MOD_ID+".gear";
    public static final String COUNT = PritheeBeCareful.MOD_ID+".count";
    public static final String REINFORCE = PritheeBeCareful.MOD_ID+".reinforce";
    public static final String TEMPERATURE = PritheeBeCareful.MOD_ID+".temperature";
    public static final String PROGRESS = PritheeBeCareful.MOD_ID+".progress";
    public static final String EXPERIENCE = PritheeBeCareful.MOD_ID+".experience";
    public static final String STATUS = PritheeBeCareful.MOD_ID+".status";
    public static final String CLOCK = PritheeBeCareful.MOD_ID+".clock";
    ...
    public static boolean addMetalStats(List<Component> tooltip, ItemStack itemstack) {
        ...
        tooltip.add(
            Component.translatable("tooltip."+PritheeBeCareful.MOD_ID+".reinforce_item.progress").append(":").withStyle(ChatFormatting.GRAY)
        ...
        tooltip.add(
            Component.translatable("tooltip."+PritheeBeCareful.MOD_ID+".reinforce_item.temperature").append(":").withStyle(ChatFormatting.GOLD)
                .append(Component.literal(" ")
        ...
        tooltip.add(
            Component.translatable("tooltip."+PritheeBeCareful.MOD_ID+".reinforce_item.experience").append(":").withStyle(ChatFormatting.GREEN)
                .append(Component.literal(" ")
        ...
        tooltip.add(
            Component.translatable("tooltip."+PritheeBeCareful.MOD_ID+".reinforce_item.malleability").append(":").withStyle(ChatFormatting.LIGHT_PURPLE)
                .append(Component.literal(" ")
        ...
        tooltip.add(
            Component.translatable("tooltip."+PritheeBeCareful.MOD_ID+".reinforce_item.points").append(":").withStyle(ChatFormatting.GRAY)
    ...
    public Component getName(ItemStack itemstack) {
        ...
        if(tag == null) {
            return Component.translatable(("item."+PritheeBeCareful.MOD_ID+".reinforce_item"));
        }
        ...
        return Component.literal(
            I18n.get(
                "item."+PritheeBeCareful.MOD_ID+".reinforce_item." + status,
                Component.translatable("forging."+PritheeBeCareful.MOD_ID+".material."+material).getString(),
                Component.translatable("forging."+PritheeBeCareful.MOD_ID+".gear."+gear).getString(),
                reinforce
            )
        );
    }
