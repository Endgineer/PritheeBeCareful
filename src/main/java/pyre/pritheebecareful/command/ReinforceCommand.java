package pyre.pritheebecareful.command;

import static pyre.pritheebecareful.ReinforceModifier.REINFORCE_KEY;
import static pyre.pritheebecareful.command.ModCommands.PERMISSION_GAME_COMMANDS;
