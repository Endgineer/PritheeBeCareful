package pyre.pritheebecareful.config;
...
import pyre.pritheebecareful.setup.Sounds;
import slimeknights.tconstruct.library.tools.stat.FloatToolStat;
import slimeknights.tconstruct.library.tools.stat.ToolStats;

import static pyre.pritheebecareful.util.ToolLevellingUtil.*;
...
public class Config {
    ...
    private static void generalConfig(ForgeConfigSpec.Builder builder) {
        ...
        toolsSlotGainingMethod = builder.comment("Method of gaining modifier slots for tools.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.tools_slot_gaining_method")
        ...
        rangedSlotGainingMethod = builder.comment("Method of gaining modifier slots for ranged weapons.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.ranged_slot_gaining_method")
        ...
        armorSlotGainingMethod = builder.comment("Method of gaining modifier slots for armor.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.armor_slot_gaining_method")
        ...
        staffSlotGainingMethod = builder.comment("Method of gaining modifier slots for staffs.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.staff_slot_gaining_method")
                .defineEnum("staffSlotGainingMethod", GainingMethod.PREDEFINED_ORDER, EnumGetMethod.NAME_IGNORECASE, GainingMethod.values());

        levelingConfig(builder);

        forgingConfig(builder);
        
        slotsConfig(builder);

        toolsStatGainingMethod = builder.comment("Method of gaining stats for tools.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.tools_stat_gaining_method")
        ...
        rangedStatGainingMethod = builder.comment("Method of gaining stats for tools.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.ranged_stat_gaining_method")
        ...
        armorStatGainingMethod = builder.comment("Method of gaining stats for armor.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.armor_stat_gaining_method")
        ...
        staffStatGainingMethod = builder.comment("Method of gaining stats for staffs.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.staff_stat_gaining_method")
    ...
    private static void forgingConfig(ForgeConfigSpec.Builder builder) {
        ...
        thermalRelaxation = builder.comment("The higher this coefficient, the faster the forge will heat and cool.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.thermal_relaxation")
        ...
        heatTransfer = builder.comment("The higher this coefficient, the faster all materials will heat and cool.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.heat_transfer")
    ...
    private static void levelingConfig(ForgeConfigSpec.Builder builder) {
        ...
        broadToolRequiredXpMultiplier = builder.comment("Additional multiplier for broad tools for experience required to level up.")
                .translation("config."+PritheeBeCareful.MOD_ID+".general.broad_tool_required_xp_multiplier")
    ...
    private static void slotsConfig(ForgeConfigSpec.Builder builder) {
        ...
        toolsSlotTypeRandomPool = builder.comment("Set of modifier slot types from which random slot will be awarded when leveling up tools.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".general.slots.tools_slot_type_random_pool")
        ...
        toolsSlotTypeOrder = builder.comment("List of modifier slot types (in order) that will be awarded when leveling up tools. If level is higher than list size the mod will start over.",
                        ...
                        "Allowed values: " + String.join(", ", getToolSlotTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.slots.tools_slot_type_order")
        ...
        rangedSlotTypeRandomPool = builder.comment("Set of modifier slot types from which random slot will be awarded when leveling up ranged weapons.",
                        ...
                        "Allowed values: " + String.join(", ", getToolSlotTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.slots.ranged_slot_type_random_pool")
        ...
        rangedSlotTypeOrder = builder.comment("List of modifier slot types (in order) that will be awarded when leveling up ranged weapons. If level is higher than list size the mod will start over.",
                        ...
                        "Allowed values: " + String.join(", ", getToolSlotTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.slots.ranged_slot_type_order")
        ...
        armorSlotTypeRandomPool = builder.comment("Set of modifier slot types from which random slot will be awarded when leveling up armor.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".general.modifiers.armor_slot_type_random_pool")
        ...
        armorSlotTypeOrder = builder.comment("List of modifier slot types (in order) that will be awarded when leveling up armor. If level is higher than list size the mod will start over.",
                        ...
                        "Allowed values: " + String.join(", ", getArmorSlotTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.slots.armor_slot_type_order")
        ...
        staffSlotTypeRandomPool = builder.comment("Set of modifier slot types from which random slot will be awarded when leveling up staffs.",
                        ...
                        "Allowed values: " + String.join(", ", getArmorSlotTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.modifiers.staff_slot_type_random_pool")
        ...
        staffSlotTypeOrder = builder.comment("List of modifier slot types (in order) that will be awarded when leveling up staffs. If level is higher than list size the mod will start over.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".general.slots.staff_slot_type_order")
    ...
    private static void statsConfig(ForgeConfigSpec.Builder builder) {
        ...
        toolsStatTypeRandomPool = builder.comment("Set of stat types from which random stat will be awarded when leveling up tools.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.tools_stat_type_random_pool")
        ...
        toolsStatTypeOrder = builder.comment("List of stat types (in order) that will be awarded when leveling up tools. If level is higher than list size the mod will start over.",
                        ...
                        "Allowed values: " + String.join(", ", getToolStatTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.tools_stat_type_order")
        ...
        rangedStatTypeRandomPool = builder.comment("Set of stat types from which random stat will be awarded when leveling up ranged weapons.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.ranged_stat_type_random_pool")
        ...
        rangedStatTypeOrder = builder.comment("List of stat types (in order) that will be awarded when leveling up ranged weapons. If level is higher than list size the mod will start over.",
                        ...
                        "Possible values: " + String.join(", ", getRangedStatTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.ranged_stat_type_order")
        ...
        armorStatTypeRandomPool = builder.comment("Set of stat types from which random stat will be awarded when leveling up armor.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.armor_stat_type_random_pool")
        ...
        armorStatTypeOrder = builder.comment("List of stat types (in order) that will be awarded when leveling up armor. If level is higher than list size the mod will start over.",
                        ...
                        "Allowed values: " + String.join(", ", getArmorStatTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.armor_stat_type_order")
        ...
        staffStatTypeRandomPool = builder.comment("Set of stat types from which random stat will be awarded when leveling up staffs.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.staff_stat_type_random_pool")
        ...
        staffStatTypeOrder = builder.comment("List of stat types (in order) that will be awarded when leveling up staffs. If level is higher than list size the mod will start over.",
                        ...
                        "Allowed values: " + String.join(", ", getStaffStatTypes()))
                .translation("config."+PritheeBeCareful.MOD_ID+".general.stats.staff_stat_type_order")
    ...
    private static void toolStatsValuesConfig(ForgeConfigSpec.Builder builder) {
        ...
        toolDurabilityValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.durability")
                .defineInRange(DURABILITY, 50, 1, 1000);

        toolAttackDamageValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.attack_damage")
                .defineInRange(ATTACK_DAMAGE, 0.5D, 0.1D, 10D);

        toolAttackSpeedValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.attack_speed")
                .defineInRange(ATTACK_SPEED, 0.25D, 0.1D, 10D);

        toolMiningSpeedValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.mining_speed")
    ...
    private static void rangedStatsValuesConfig(ForgeConfigSpec.Builder builder) {
        ...
        rangedDurabilityValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.durability")
                .defineInRange(DURABILITY, 30, 1, 1000);
    
        rangedDrawSpeedValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.draw_speed")
                .defineInRange(DRAW_SPEED, 0.1D, 0.1D, 10D);
    
        rangedVelocityValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.velocity")
                .defineInRange(VELOCITY, 0.1D, 0.1D, 10D);
    
        rangedAccuracyValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.accuracy")
                .defineInRange(ACCURACY, 0.01D, 0.01D, 1D);
    
        rangedProjectileDamageValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.projectile_damage")
                .defineInRange(PROJECTILE_DAMAGE, 0.1D, 0.1D, 10D);
    
        rangedAttackDamageValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.attack_damage")
                .defineInRange(ATTACK_DAMAGE, 0.5D, 0.1D, 10D);
    
        rangedAttackSpeedValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.attack_speed")
                .defineInRange(ATTACK_SPEED, 0.25D, 0.1D, 10D);
    ...
    private static void armorStatsValuesConfig(ForgeConfigSpec.Builder builder) {
        ...
        armorDurabilityValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.durability")
                .defineInRange(DURABILITY, 50, 1, 1000);

        armorArmorValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.armor")
                .defineInRange(ARMOR, 0.25D, 0.1D, 10D);

        armorArmorToughnessValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.armor_toughness")
                .defineInRange(ARMOR_TOUGHNESS, 0.1D, 0.1D, 10D);

        armorKnockbackResistanceValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.knockback_resistance")
    ...
    private static void staffStatsValuesConfig(ForgeConfigSpec.Builder builder) {
        ...
        staffDurabilityValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.durability")
                .defineInRange(DURABILITY, 30, 1, 1000);
        
        staffDrawSpeedValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.draw_speed")
                .defineInRange(DRAW_SPEED, 0.1D, 0.1D, 10D);
        
        staffVelocityValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.velocity")
                .defineInRange(VELOCITY, 0.1D, 0.1D, 10D);
        
        staffAccuracyValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.accuracy")
                .defineInRange(ACCURACY, 0.01D, 0.01D, 1D);
        
        staffProjectileDamageValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stat.projectile_damage")
                .defineInRange(PROJECTILE_DAMAGE, 0.1D, 0.1D, 10D);
        
        staffArmorValue = builder.translation("tooltip."+PritheeBeCareful.MOD_ID+".stats.armor")
                .defineInRange(ARMOR, 0.25D, 0.1D, 10D);
    ...
    private static void toolLevellingConfig(ForgeConfigSpec.Builder builder) {
        ...
        damageDealt = builder.comment("Melee only!", "If true, base experience value gained for attacking is equal to damage dealt (rounded to whole number), otherwise 1.")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.damage_dealt")
        ...
        damageTaken = builder.comment("If true, base experience value gained for taking damage is equal to damage taken (rounded to whole number), otherwise 1.")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.damage_taken")
        ...
        damageBlocked = builder.comment("If true, base experience value gained for blocking damage is equal to damage blocked (rounded to whole number), otherwise 1.")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.damage_blocked")
        ...
        enablePvp = builder.comment("If true, allows to gain experience from dealing damage to or taking damage from other players.")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.enable_pvp")
                .define("pvp", true);
        flyingTime = builder.comment("The time (in ticks) of continuous flight using an elytra after which experience points will be awarded.",
                        "20 ticks = 1 second")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.flying_time")
    ...
    private static void actionsConfig(ForgeConfigSpec.Builder builder) {
        ...
        enableMiningXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.mining")
                .define("mining", true);

        enableHarvestingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.harvesting")
                .define("harvesting", true);

        enableShearingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.shearing")
                .define("shearing", true);

        enableStrippingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.stripping")
                .define("stripping", true);

        enableScrappingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.scrapping")
                .define("scrapping", true);

        enableWaxingOffXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.waxing_off")
                .define("waxingOff", true);

        enableTillingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.tilling")
                .define("tilling", true);

        enablePathMakingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.path_making")
                .define("pathMaking", true);

        enableAttackingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.attacking")
                .define("attacking", true);

        enableShootingXp = builder.comment("Applies to ranged weapons like longbows and crossbows.")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.shooting")
                .define("shooting", true);

        enableTakingDamageXp = builder.comment("Applies to armor only.")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.taking_damage")
                .define("takingDamage", true);
        
        enableBlockingDamageXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.blocking_damage")
        ...
        enableThornsXp = builder.comment("Applies to armor only. Thorns modifier gives 15% chance per level to gain experience.")
                .translation("config."+PritheeBeCareful.MOD_ID+".levelling.thorns")
                .define("thorns", true);
        
        enableFlyingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.flying")
                .define("flying", true);
        
        enablePlowingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.plowing")
                .define("plowing", true);
        
        enablePathMakerXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.path_maker")
                .define("path_maker", true);
        
        enableSnowdriftXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.snowdrift")
                .define("snowdrift", true);
        
        enableFlamewakeXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.flamewake")
                .define("flamewake", true);
        
        enableFrostWalkerXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.frost_walker")
                .define("frost_walker", true);
        
        enableWarpingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.warping")
                .define("warping", true);
        
        enableFlingingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.flinging")
                .define("flinging", true);
        
        enableSpringingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.springing")
                .define("springing", true);
        
        enableBonkingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.bonking")
                .define("bonking", true);
        
        enableGlowingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.glowing")
                .define("glowing", true);
        
        enableFirestarterXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.firestarter")
    ...
    private static void bonusesConfig(ForgeConfigSpec.Builder builder) {
        ...
        bonusMiningXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.mining")
                .defineInRange("mining", 0, 0, Integer.MAX_VALUE);

        bonusHarvestingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.harvesting")
                .defineInRange("harvesting", 0, 0, Integer.MAX_VALUE);

        bonusShearingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.shearing")
                .defineInRange("shearing", 0, 0, Integer.MAX_VALUE);

        bonusStrippingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.stripping")
                .defineInRange("stripping", 0, 0, Integer.MAX_VALUE);

        bonusScrappingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.scrapping")
                .defineInRange("scrapping", 0, 0, Integer.MAX_VALUE);

        bonusWaxingOffXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.waxing_off")
                .defineInRange("waxingOff", 0, 0, Integer.MAX_VALUE);

        bonusTillingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.tilling")
                .defineInRange("tilling", 0, 0, Integer.MAX_VALUE);

        bonusPathMakingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.path_making")
                .defineInRange("pathMaking", 0, 0, Integer.MAX_VALUE);

        bonusAttackingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.attacking")
                .defineInRange("attacking", 0, 0, Integer.MAX_VALUE);

        bonusShootingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.shooting")
                .defineInRange("shooting", 0, 0, Integer.MAX_VALUE);

        bonusTakingDamageXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.taking_damage")
                .defineInRange("takingDamage", 0, 0, Integer.MAX_VALUE);
        
        bonusBlockingDamageXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.blocking_damage")
        ...
        bonusFlyingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.flying")
                .defineInRange("flying", 0, 0, Integer.MAX_VALUE);
        
        bonusPlowingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.plowing")
                .defineInRange("plowing", 0, 0, Integer.MAX_VALUE);
        
        bonusPathMakerXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.path_maker")
                .defineInRange("path_maker", 0, 0, Integer.MAX_VALUE);
        
        bonusSnowdriftXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.snowdrift")
                .defineInRange("snowdrift", 0, 0, Integer.MAX_VALUE);
        
        bonusFlamewakeXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.flamewake")
                .defineInRange("flamewake", 0, 0, Integer.MAX_VALUE);
        
        bonusFrostWalkerXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.frost_walker")
                .defineInRange("frost_walker", 0, 0, Integer.MAX_VALUE);
        
        bonusWarpingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.warping")
                .defineInRange("warping", 0, 0, Integer.MAX_VALUE);
        
        bonusFlingingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.flinging")
                .defineInRange("flinging", 0, 0, Integer.MAX_VALUE);
        
        bonusSpringingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.springing")
                .defineInRange("springing", 0, 0, Integer.MAX_VALUE);
        
        bonusBonkingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.bonking")
                .defineInRange("bonking", 0, 0, Integer.MAX_VALUE);
        
        bonusGlowingXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.glowing")
                .defineInRange("glowing", 0, 0, Integer.MAX_VALUE);
        
        bonusFirestarterXp = builder.translation("config."+PritheeBeCareful.MOD_ID+".levelling.firestarter")
    ...
    private static void clientConfig(ForgeConfigSpec.Builder builder) {
        ...
        enableLevelUpMessage = builder.comment("If true, shows chat message on tool level ups.")
                .translation("config."+PritheeBeCareful.MOD_ID+".client.messages")
                .define("message", true);
        ...
        squashLevelPluses = builder.comment("If true, uses alternative level name suffix for high level tools.",
                ...
                .translation("config."+PritheeBeCareful.MOD_ID+".client.squash_pluses")
                .define("squashPluses", false);

        levelUpSound = builder.comment("")
                .translation("config."+PritheeBeCareful.MOD_ID+".client.sound")
