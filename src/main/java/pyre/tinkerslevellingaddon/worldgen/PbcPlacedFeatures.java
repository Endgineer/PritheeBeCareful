...
public class PbcPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, DEEPSLATE_ANCIENT_RUBBLE_KEY, configuredFeatures.getOrThrow(PbcConfiguredFeatures.DEEPSLATE_ANCIENT_RUBBLE_KEY), PbcOrePlacement.commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.BOTTOM, VerticalAnchor.absolute(0))));
    }
